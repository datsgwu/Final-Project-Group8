...
#download yolo3.weights from https://pjreddie.com/media/files/yolov3.weights.
    #I could not figure out how to make this a command and had to do it manually
#python yolo.py -w yolo3.weights
...
#Note: model expects 416X416 pixels
